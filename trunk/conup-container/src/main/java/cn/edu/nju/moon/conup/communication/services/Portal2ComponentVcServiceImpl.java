...
public class Portal2ComponentVcServiceImpl implements ArcService, FreenessService, OndemandService,ComponentUpdateService {
	private OndemandService proc2ComponentOndemandService;
	private ArcService proc2ComponentArcService;
	private OndemandService authComponentOndemandService;
	private ArcService authComponentArcService;

	public OndemandService getProc2ComponentOndemandService(){
		return proc2ComponentOndemandService;
	}
	@Reference
	public void setProc2ComponentOndemandService(OndemandService ondemandService){
		 this.proc2ComponentOndemandService = ondemandService;
	}

	public ArcService getProc2ComponentArcService(){
		return proc2ComponentArcService;
	}
	@Reference
	public void setProc2ComponentArcService(ArcService arcService){
		 this.proc2ComponentArcService = arcService;
	}

	public OndemandService getAuthComponentOndemandService(){
		return authComponentOndemandService;
	}
	@Reference
	public void setAuthComponentOndemandService(OndemandService ondemandService){
		 this.authComponentOndemandService = ondemandService;
	}

	public ArcService getAuthComponentArcService(){
		return authComponentArcService;
	}
	@Reference
	public void setAuthComponentArcService(ArcService arcService){
		 this.authComponentArcService = arcService;
	}
	...
	private final static Logger LOGGER = Logger.getLogger(Portal2ComponentVcServiceImpl.class.getName());
	...
	public void update(Arc arc, String flag) {
		LOGGER.info("****Portal2ComponentVcServiceImpl.update(...) Arc: source= " + arc.getSourceComponent() + ", target=" + arc.getTargetComponent() + 
				"flag: " + flag);
//		System.out.println("Portal2ComponentVcServiceImpl.update(...) Arc: source=" + arc.getSourceComponent() + ", target=" + arc.getTargetComponent());
...
//			System.out.println("\t" + component);
		...
		Class<Portal2ComponentVcServiceImpl> vcServiceImpl = Portal2ComponentVcServiceImpl.class;
...
//						System.out.println("this=" + this + ", arcService=" + arcService);
		...
		LOGGER.info("**** >>in Portal2ComponentVcServiceImpl.setUp(...) print informations start:");
		ContainerPrinter containerPrinter = new ContainerPrinter();
		containerPrinter.printInArcRegistry(InArcRegistryImpl.getInstance());
		containerPrinter.printOutArcRegistry(OutArcRegistryImpl.getInstance());
		containerPrinter.printTransactionRegistry(TransactionRegistryImpl.getInstance());
		LOGGER.info("**** >>in Portal2ComponentVcServiceImpl.setUp(...) print informations end. " +
...
//				System.out.println("txRegistry remainiing size()=" + txRegistry.getDependencies().size());
		...
		LOGGER.info("**** >>in Portal2ComponentVcServiceImpl.cleanUp(...) print informations start:");
		ContainerPrinter containerPrinter = new ContainerPrinter();
...
//		System.out.println("TransactionRegistry when cleanup:");
		...
		LOGGER.info("**** >>in Portal2ComponentVcServiceImpl.cleanUp(...) print informations end");
...
//	@Override
	public boolean reqOndemandSetup(String currentComponent,
		...
		LOGGER.info("**** in Portal2ComponentVcServiceImpl.reqOndemandSetup(...):"+
...
//				System.out.println("Invalid data found while onDemandSetUp");
		...
		LOGGER.info("\n**** >>in Portal2ComponentVcServiceImpl.onDemandSetUp(...) print informations start:");
		ContainerPrinter containerPrinter = new ContainerPrinter();
...
//		System.out.println("TransactionRegistry after onDemandSetUp():");
		containerPrinter.printTransactionRegistry(TransactionRegistryImpl.getInstance());
		LOGGER.info("\n**** <<in Portal2ComponentVcServiceImpl.onDemandSetUp(...) print informations end.");
...
//					System.out.println("Access endpoint in Portal2ComponentVcServiceImpl: " + endpoint);
