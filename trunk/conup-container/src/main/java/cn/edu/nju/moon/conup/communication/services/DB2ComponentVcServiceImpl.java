...
public class DB2ComponentVcServiceImpl implements ArcService, FreenessService, OndemandService,ComponentUpdateService {
	...
	private final static Logger LOGGER = Logger.getLogger(DB2ComponentVcServiceImpl.class.getName());
	...
	public void update(Arc arc, String flag) {
		LOGGER.info("****DB2ComponentVcServiceImpl.update(...) Arc: source= " + arc.getSourceComponent() + ", target=" + arc.getTargetComponent() + 
				"flag: " + flag);
//		System.out.println("DB2ComponentVcServiceImpl.update(...) Arc: source=" + arc.getSourceComponent() + ", target=" + arc.getTargetComponent());
...
//			System.out.println("\t" + component);
		...
		Class<DB2ComponentVcServiceImpl> vcServiceImpl = DB2ComponentVcServiceImpl.class;
...
//						System.out.println("this=" + this + ", arcService=" + arcService);
		...
		LOGGER.info("**** >>in DB2ComponentVcServiceImpl.setUp(...) print informations start:");
		ContainerPrinter containerPrinter = new ContainerPrinter();
		containerPrinter.printInArcRegistry(InArcRegistryImpl.getInstance());
		containerPrinter.printOutArcRegistry(OutArcRegistryImpl.getInstance());
		containerPrinter.printTransactionRegistry(TransactionRegistryImpl.getInstance());
		LOGGER.info("**** >>in DB2ComponentVcServiceImpl.setUp(...) print informations end. " +
...
//				System.out.println("txRegistry remainiing size()=" + txRegistry.getDependencies().size());
		...
		LOGGER.info("**** >>in DB2ComponentVcServiceImpl.cleanUp(...) print informations start:");
		ContainerPrinter containerPrinter = new ContainerPrinter();
...
//		System.out.println("TransactionRegistry when cleanup:");
		...
		LOGGER.info("**** >>in DB2ComponentVcServiceImpl.cleanUp(...) print informations end");
...
//	@Override
	public boolean reqOndemandSetup(String currentComponent,
		...
		LOGGER.info("**** in DB2ComponentVcServiceImpl.reqOndemandSetup(...):"+
...
//				System.out.println("Invalid data found while onDemandSetUp");
		...
		LOGGER.info("\n**** >>in DB2ComponentVcServiceImpl.onDemandSetUp(...) print informations start:");
		ContainerPrinter containerPrinter = new ContainerPrinter();
...
//		System.out.println("TransactionRegistry after onDemandSetUp():");
		containerPrinter.printTransactionRegistry(TransactionRegistryImpl.getInstance());
		LOGGER.info("\n**** <<in DB2ComponentVcServiceImpl.onDemandSetUp(...) print informations end.");
...
//					System.out.println("Access endpoint in DB2ComponentVcServiceImpl: " + endpoint);
