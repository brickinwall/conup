...
public class Proc2ComponentVcServiceImpl implements ArcService, FreenessService, OndemandService,ComponentUpdateService {
	private OndemandService dB2ComponentOndemandService;
	private ArcService dB2ComponentArcService;
	private OndemandService authComponentOndemandService;
	private ArcService authComponentArcService;

	public OndemandService getdB2ComponentOndemandService(){
		return dB2ComponentOndemandService;
	}
	@Reference
	public void setdB2ComponentOndemandService(OndemandService ondemandService){
		 this.dB2ComponentOndemandService = ondemandService;
	}

	public ArcService getdB2ComponentArcService(){
		return dB2ComponentArcService;
	}
	@Reference
	public void setdB2ComponentArcService(ArcService arcService){
		 this.dB2ComponentArcService = arcService;
	}
	...
	private final static Logger LOGGER = Logger.getLogger(Proc2ComponentVcServiceImpl.class.getName());
	...
	public void update(Arc arc, String flag) {
		LOGGER.info("****Proc2ComponentVcServiceImpl.update(...) Arc: source= " + arc.getSourceComponent() + ", target=" + arc.getTargetComponent() + 
				"flag: " + flag);
//		System.out.println("Proc2ComponentVcServiceImpl.update(...) Arc: source=" + arc.getSourceComponent() + ", target=" + arc.getTargetComponent());
...
//			System.out.println("\t" + component);
		...
		Class<Proc2ComponentVcServiceImpl> vcServiceImpl = Proc2ComponentVcServiceImpl.class;
...
//						System.out.println("this=" + this + ", arcService=" + arcService);
		...
		LOGGER.info("**** >>in Proc2ComponentVcServiceImpl.setUp(...) print informations start:");
		ContainerPrinter containerPrinter = new ContainerPrinter();
		containerPrinter.printInArcRegistry(InArcRegistryImpl.getInstance());
		containerPrinter.printOutArcRegistry(OutArcRegistryImpl.getInstance());
		containerPrinter.printTransactionRegistry(TransactionRegistryImpl.getInstance());
		LOGGER.info("**** >>in Proc2ComponentVcServiceImpl.setUp(...) print informations end. " +
...
//				System.out.println("txRegistry remainiing size()=" + txRegistry.getDependencies().size());
		...
		LOGGER.info("**** >>in Proc2ComponentVcServiceImpl.cleanUp(...) print informations start:");
		ContainerPrinter containerPrinter = new ContainerPrinter();
...
//		System.out.println("TransactionRegistry when cleanup:");
		...
		LOGGER.info("**** >>in Proc2ComponentVcServiceImpl.cleanUp(...) print informations end");
...
//	@Override
	public boolean reqOndemandSetup(String currentComponent,
		...
		LOGGER.info("**** in Proc2ComponentVcServiceImpl.reqOndemandSetup(...):"+
...
//				System.out.println("Invalid data found while onDemandSetUp");
		...
		LOGGER.info("\n**** >>in Proc2ComponentVcServiceImpl.onDemandSetUp(...) print informations start:");
		ContainerPrinter containerPrinter = new ContainerPrinter();
...
//		System.out.println("TransactionRegistry after onDemandSetUp():");
		containerPrinter.printTransactionRegistry(TransactionRegistryImpl.getInstance());
		LOGGER.info("\n**** <<in Proc2ComponentVcServiceImpl.onDemandSetUp(...) print informations end.");
...
//					System.out.println("Access endpoint in Proc2ComponentVcServiceImpl: " + endpoint);
