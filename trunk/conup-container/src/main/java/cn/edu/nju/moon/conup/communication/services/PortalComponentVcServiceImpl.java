...
public class PortalComponentVcServiceImpl implements ArcService, FreenessService, OndemandService,ComponentUpdateService, ComponentConfService {
	private OndemandService procComponentOndemandService;
	private ArcService procComponentArcService;
	private OndemandService authComponentOndemandService;
	private ArcService authComponentArcService;

	public OndemandService getProcComponentOndemandService(){
		return procComponentOndemandService;
	}
	@Reference
	public void setProcComponentOndemandService(OndemandService ondemandService){
		 this.procComponentOndemandService = ondemandService;
	}

	public ArcService getProcComponentArcService(){
		return procComponentArcService;
	}
	@Reference
	public void setProcComponentArcService(ArcService arcService){
		 this.procComponentArcService = arcService;
	}
	...
	private final static Logger LOGGER = Logger.getLogger(PortalComponentVcServiceImpl.class.getName());
	...
	public void update(Arc arc, String flag) {
		LOGGER.info("****PortalComponentVcServiceImpl.update(...) Arc: source= " + arc.getSourceComponent() + ", target=" + arc.getTargetComponent() + 
				"flag: " + flag);
//		System.out.println("PortalComponentVcServiceImpl.update(...) Arc: source=" + arc.getSourceComponent() + ", target=" + arc.getTargetComponent());
...
//			System.out.println("\t" + component);
		...
		Class<PortalComponentVcServiceImpl> vcServiceImpl = PortalComponentVcServiceImpl.class;
...
//						System.out.println("this=" + this + ", arcService=" + arcService);
		...
		LOGGER.info("**** >>in PortalComponentVcServiceImpl.setUp(...) print informations start:");
		ContainerPrinter containerPrinter = new ContainerPrinter();
		containerPrinter.printInArcRegistry(InArcRegistryImpl.getInstance());
		containerPrinter.printOutArcRegistry(OutArcRegistryImpl.getInstance());
		containerPrinter.printTransactionRegistry(TransactionRegistryImpl.getInstance());
		LOGGER.info("**** >>in PortalComponentVcServiceImpl.setUp(...) print informations end. " +
...
//				System.out.println("txRegistry remainiing size()=" + txRegistry.getDependencies().size());
		...
		LOGGER.info("**** >>in PortalComponentVcServiceImpl.cleanUp(...) print informations start:");
		ContainerPrinter containerPrinter = new ContainerPrinter();
...
//		System.out.println("TransactionRegistry when cleanup:");
		...
		LOGGER.info("**** >>in PortalComponentVcServiceImpl.cleanUp(...) print informations end");
...
//	@Override
	public boolean reqOndemandSetup(String currentComponent,
		...
		LOGGER.info("**** in PortalComponentVcServiceImpl.reqOndemandSetup(...):"+
...
//				System.out.println("Invalid data found while onDemandSetUp");
		...
		LOGGER.info("\n**** >>in PortalComponentVcServiceImpl.onDemandSetUp(...) print informations start:");
		ContainerPrinter containerPrinter = new ContainerPrinter();
...
//		System.out.println("TransactionRegistry after onDemandSetUp():");
		containerPrinter.printTransactionRegistry(TransactionRegistryImpl.getInstance());
		LOGGER.info("\n**** <<in PortalComponentVcServiceImpl.onDemandSetUp(...) print informations end.");
...
//					System.out.println("Access endpoint in PortalComponentVcServiceImpl: " + endpoint);
