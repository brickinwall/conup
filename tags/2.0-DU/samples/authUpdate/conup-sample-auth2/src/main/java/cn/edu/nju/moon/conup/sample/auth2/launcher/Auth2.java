...
public class Auth2 {
	public static void main(String[] args) throws Exception {
		...
		String contributionURL = ContributionLocationHelper.getContributionLocation(Auth2.class);
...
//      String domainUri = "uri:" + domainName + "?" + userIdPsw;
        container.setBusinessComponentName("Auth2Component", compositeLocation, absContributionPath, null, domainUri);
