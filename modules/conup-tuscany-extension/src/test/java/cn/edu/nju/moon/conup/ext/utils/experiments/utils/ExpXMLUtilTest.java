...
public class ExpXMLUtilTest {
	...
	public void testGetExpSetting() {
		...
		assertTrue(expSetting.toString().equals("indepRun:50 nThreads:100 threadId:50 rqstInterval:50 targetComp:CurrencyConverter ipAddress:114.212.191.22 baseDir:/home/conup type:timeliness"));
	}
