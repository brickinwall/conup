...
public class MethodAnalyzer {
	...
	/**
	 *Component-invoked event infor like this: COM.ComponentName;methodName.location
	 */
...
//						System.out.println("----------------------StatesDDA"+statesDDA);
						...
						trigstart.add(new MethodInsnNode(INVOKESTATIC, "cn/edu/nju/moon/conup/pre/DynamicDependencesManager", "getInstance", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcn/edu/nju/moon/conup/pre/DynamicDependencesManager;"));									
...
//						trigstart.add(new MethodInsnNode(INVOKEVIRTUAL, "java/lang/Object", "toString", "()Ljava/lang/String;"));
						...
						trigstart.add(new MethodInsnNode(INVOKEVIRTUAL, "cn/edu/nju/moon/conup/pre/DynamicDependencesManager", "trigger", "(Ljava/lang/String;Ljava/lang/String;)V"));
...
//							System.out.println(((AbstractInsnNode)i1).toString());					
							...
							if(runNum > 0){
									if(runinf.contains(i1)){										
										...
										setUp.add(new MethodInsnNode(INVOKESTATIC, "cn/edu/nju/moon/conup/pre/DynamicDependencesManager", "getInstance", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcn/edu/nju/moon/conup/pre/DynamicDependencesManager;"));
										setUp.add(new MethodInsnNode(INVOKEVIRTUAL, "cn/edu/nju/moon/conup/pre/DynamicDependencesManager", "notifyRun", "()V"));
								...
								if (ejbinf.containsKey(i1)) {
							        ...
							        trig.add(new MethodInsnNode(INVOKESTATIC, "cn/edu/nju/moon/conup/pre/DynamicDependencesManager", "getInstance", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lcn/edu/nju/moon/conup/pre/DynamicDependencesManager;"));									
			...
			//						trig.add(new MethodInsnNode(INVOKEVIRTUAL, "java/lang/Object", "toString", "()Ljava/lang/String;"));
									...
									trig.add(new MethodInsnNode(INVOKEVIRTUAL, "cn/edu/nju/moon/conup/pre/DynamicDependencesManager", "trigger", "(Ljava/lang/String;Ljava/lang/String;)V"));
...
//              minimizeState();
				...
				trigstart.add(new MethodInsnNode(INVOKESTATIC, "cn/edu/nju/DynamicDependencesManager", "getInstance", "(Ljava/lang/String;)Lcn/edu/nju/DynamicDependencesManager;"));									
				trigstart.add(new LdcInsnNode(mn.name));
				trigstart.add(new LdcInsnNode("Start"));						
				trigstart.add(new MethodInsnNode(INVOKEVIRTUAL, "cn/edu/nju/DynamicDependencesManager", "trigger", "(Ljava/lang/String;Ljava/lang/String;)V"));
				insns.insert(insns.getFirst(),trigstart);
			    Iterator<AbstractInsnNode> i = insns.iterator();
				int src = 0;
				while (i.hasNext()) {
...
//					System.out.println(((AbstractInsnNode)i1).toString());					
					if (i1 instanceof MethodInsnNode) {	
						...
						if (ejbinf.containsKey(i1)) {
					        ...
					        trig.add(new MethodInsnNode(INVOKESTATIC, "cn/edu/nju/DynamicDependencesManager", "getInstance", "(Ljava/lang/String;)Lcn/edu/nju/DynamicDependencesManager;"));									
					        trig.add(new LdcInsnNode(mn.name));
							trig.add(new LdcInsnNode(ejbinf.get(i1)));
							trig.add(new MethodInsnNode(INVOKEVIRTUAL, "cn/edu/nju/DynamicDependencesManager", "trigger", "(Ljava/lang/String;Ljava/lang/String;)V"));
	...
	public void recognize_state2(int src, int last_state, InsnList insns) {
			...
			if (isAnalyze[src]==0) {				
				...
				if (an instanceof MethodInsnNode) {
					...
					String methodName = ((MethodInsnNode) an).name;
...
//					System.out.println(isCom(owner));
					if (isCom(owner)!= null) {
						...
						String e = "COM." + isCom(owner)+":"+methodName + "."	+src;
