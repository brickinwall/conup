...
public class UpdateContextPayloadCreator {
	...
	public static String createPayload(UpdateOperationType operationType,
		...
		result = UpdateContextPayload.OPERATION_TYPE + ":" + operationType + ","
				+ UpdateContextPayload.COMP_IDENTIFIER + ":" + targetCompIdentifier
				+ "," + UpdateContextPayload.BASE_DIR + ":" + baseDir + ","
				+ UpdateContextPayload.CLASS_FILE_PATH + ":" + classFilePath + ","
	...
	public static String createPayload(UpdateOperationType operationType,
		...
		StringBuffer result = new StringBuffer(createPayload(operationType,
				...
				compsiteUri));
		result.append(",").append(UpdateContextPayload.SCOPE).append(":").append(scope.toString());
